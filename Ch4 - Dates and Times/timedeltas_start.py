...
if afd < today:
    print("april fool's day already went by %d ago" % (today - afd).days)
else:
    time_to_afd = afd - today
    print("it is just, " + str(time_to_afd.days), " until next April Fools' Day!")

# TODO: Now calculate the amount of time until April Fool's Day
time_to_afd = date(today.year + 1, 4, 1) - today
print("it is just, " + str(time_to_afd.days), " until April Fools' Day next year!")
